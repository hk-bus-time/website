...
Welcome to HK Bus Time, a mobile application developed and owned by Tommy To, an individual, that provides real-time bus route information and estimated times of arrival (ETAs) for public transportation in Hong Kong. By downloading, accessing, or using HK Bus Time ("the App"), you agree to be bound by these Terms of Service ("ToS"). If you do not agree with these terms, please do not use the App.

## 1. Use of the App
- **Eligibility**: There are no age restrictions for using the App, but you must have the legal capacity to agree to these ToS.
- **Permitted Use**: The App is for personal, non-commercial use only. You may not reproduce, distribute, modify, or create derivative works of the App without prior written consent from Tommy To.
- **Compliance**: You agree to use the App in compliance with all applicable laws and regulations in Hong Kong.
...
- **Prohibited Actions**: You agree not to:
  ...
  - Share or distribute App content for commercial purposes without permission.
  - Attempt to access unauthorized parts of the App or its backend systems.
- **Normal Use**: You agree to use the App as intended, solely for accessing bus route information and ETAs.

## 5. Intellectual Property
- All content, design, and functionality of the App, including but not limited to text, graphics, and code, are the property of Tommy To or third-party licensors (e.g., Google Maps, data.gov.hk). You are granted a limited, non-exclusive, non-transferable license to use the App for personal purposes only.

## 6. Termination
- **Right to Terminate**: Tommy To reserves the right to suspend or terminate your access to the App at any time, without notice, if you violate these ToS or engage in conduct that harms the App, its users, or its operations.
- **Effect of Termination**: Upon termination, your right to use the App will cease immediately.

## 7. Updates to Terms
- Tommy To may update these ToS at any time, including to reflect changes such as the introduction of paid features or subscriptions. The updated ToS will be posted within the App, and your continued use of the App constitutes acceptance of the revised terms.

## 8. Limitation of Liability
- To the fullest extent permitted by Hong Kong law, Tommy To shall not be liable for any direct, indirect, incidental, or consequential damages arising from your use of the App, including but not limited to errors in ETA data, service interruptions, or reliance on third-party services.
...
HK Bus Time, developed and owned by Tommy To, is committed to protecting your privacy. This Privacy Policy explains how we collect, use, store, and share information when you use our mobile application ("the App"), which provides real-time bus route information and estimated times of arrival (ETAs) for public transportation in Hong Kong. By using the App, you agree to the practices described in this Privacy Policy. If you do not agree, please do not use the App.
...
We use the collected information solely to operate and improve the App:
- **Location Data**: Used to display real-time bus routes and ETAs based on your current location.
- **Analytics Data**: Used to understand App usage patterns and improve performance and user experience.
